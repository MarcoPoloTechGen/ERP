...
export function createEnglishTranslations(dir: "ltr" | "rtl"): TranslationShape {
  return {
    ...
    dateRemindersSub: "Overdue dates and payments due in the next 7 days.",
    noDateReminders: "No date reminders for the next 7 days.",
    overdueReminder: "Overdue",
    todayReminder: "Today",
    upcomingReminderDays: (count) => `In ${count} day${count === 1 ? "" : "s"}`,
    ...
    workerWorked: "Worked",
    workerPaid: "Paid",
    workerWorkedPaid: "Worked and paid",
    ...
    projectFile_count: (count) => `${count} file${count === 1 ? "" : "s"}`,
    uploadProjectFile: "Upload file",
    noProjectFiles: "No files attached to this project.",
    downloadFile: "Download file",
    deleteFileConfirm: "Delete this file?",
    fileUploaded: "File uploaded.",
    fileDeleted: "File deleted.",
    projectAlerts: "Project alerts",
    addProjectAlert: "Add alert",
    projectAlertDate: "Alert date",
    projectAlertNote: "Note",
    projectAlertNotePlaceholder: "Mandatory note for this alert...",
    noProjectAlerts: "No manual alerts for this project.",
    projectAlertCreated: "Alert created.",
    projectAlertDeleted: "Alert deleted.",
    deleteProjectAlertConfirm: "Delete this alert?",
