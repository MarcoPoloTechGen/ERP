...
export type TranslationShape = {
  ...
  dateRemindersSub: string;
  noDateReminders: string;
  overdueReminder: string;
  todayReminder: string;
  upcomingReminderDays: (count: number) => string;
  totalWorkers: string;
  ...
  projectInfo: string;
  projectFiles: string;
  projectFile_count: (count: number) => string;
  uploadProjectFile: string;
  noProjectFiles: string;
  downloadFile: string;
  deleteFileConfirm: string;
  fileUploaded: string;
  fileDeleted: string;
  projectAlerts: string;
  addProjectAlert: string;
  projectAlertDate: string;
  projectAlertNote: string;
  projectAlertNotePlaceholder: string;
  noProjectAlerts: string;
  projectAlertCreated: string;
  projectAlertDeleted: string;
  deleteProjectAlertConfirm: string;
  manualAlert: string;
